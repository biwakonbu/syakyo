...
(defmethod not-found ((this ningle-test-app))
  (setf (response-body *reponse*) "Page not found")
  nil)

(clack.test:subtest-app "Test 3"
    *app2*
  (is (drakma:http-request (format nil "http://localhost:~D~A/404-page-not-found"
                                   clack.test:*clack-test-port*))
      "Page not found"
      "Can change the behabior on 404"))
