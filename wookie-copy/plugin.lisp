...
(defvar *plugin-asdf* nil
  "A list matching plugin (keyword) anmes to ASDF systems.")
...
(defparameter *current-plugin-name* nil
  "Used by load-plugins to tie ASDF system to a :plugin-name")
...
(defmacro defplugin (&rest asdf-defsystem-args)
   ...
   *current-plugin-name*) to the ASDF system the plugin derfines."
  `(progn
     (asdf:defsystem ,@asdf-defsystem-args)
     (wookie-copy-plugin:match-plugin-asdf wookie-copy-plugin:*current-plugin-name*
                                           ,(intern (staring-upcase (string (car asdf-defsystem-args)))
                                                    :keyword))))
